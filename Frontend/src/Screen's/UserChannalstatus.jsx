                                    ...
                                    <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
                                        <div class="relative sm:w-max flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md overflow-hidden xl:col-span-2">
                                            ...
                                            <div class="p-6 overflow-x-auto px-0 pt-0 pb-2">
                                                <table class="w-full min-w-[640px] md:max-w-[70vw] table-auto">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="border-b border-blue-gray-50 py-3 px-6 text-left">
                                                                <p class="block antialiased font-sans text-[11px] font-medium uppercase text-blue-gray-400">Video Status</p>
                                                            </th>
                                                            <th class="border-b border-blue-gray-50 py-3 px-6 text-left">
                                                            ...
                                                            videodata.length >= 0 && (
                                                                videodata.map((video) => (
                                                                    <tr key={video.owner}>
                                                                        ...
                                                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                                                            <p class="block antialiased font-sans text-xs font-medium text-blue-gray-600">{video.status}</p>
                                                                        </td>
                                                                        <td class="py-3 px-5 border-b border-blue-gray-50">
